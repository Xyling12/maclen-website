...
В конце поста добавь 1-2 уникальных хэштега: один должен быть "именным" (отсылать к породе мейн-кун или окрасу), а второй — вовлекающим/дополнительным.
...
Важно: Если в тексте указана цена в рублях, запиши ее числом в поле price. Если цены нет или она не понятна, укажи 0. Верни исключительно чистый JSON.`;
      ...
      postText += '\n\n#питомникmaclen #купитьмейнкуна #ижевск';
